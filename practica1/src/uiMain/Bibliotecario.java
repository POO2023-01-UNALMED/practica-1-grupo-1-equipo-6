...
public class Bibliotecario {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Revista revista4= new Revista((int)2,(String)"Análisis Político",(short) 2023,(short) 10, (short) 104, Revista.Meses.AGOSTO,(String)"primera",estanteria4);
	...
	//Creación de objetos folletos
		...
		Folleto folleto4= new Folleto((int)9,(String) "Pin",(short) 2016,(short)100, (String)"Biología",estanteria11);
		Folleto folleto7= new Folleto((int)10,(String) "Bed",(short) 2019,(short)290, (String)"Arte",estanteria12);
		Folleto folleto8= new Folleto((int)11,(String) "Amstel",(short) 2014,(short)279, (String)"política",estanteria3);
